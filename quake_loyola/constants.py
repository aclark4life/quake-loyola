...
INDENT = 80
KH_DRIVEWAY_CURB_CRN_R = CHARLES_WALK_W
KH_DRIVEWAY_CURB_CRN_SEGS = CHARLES_CRN_SEGS
KH_DRIVEWAY_CURB_WALK_W = CHARLES_WALK_W
KH_DRIVEWAY_HW = 128
KH_DRIVEWAY_ZT_N = FLOOR_Z2
KH_ENABLED = True
KH_FASCIA_FONT = {
...
KH_DRIVEWAY_CORRIDOR_X1 = KH_X2
KH_DRIVEWAY_CORRIDOR_X2 = KH_X2 + CHARLES_WALK_W + 2 * 128 + CHARLES_WALK_W
KH_DRIVEWAY_WS_X1 = KH_X2
KH_DRIVEWAY_JCX_W = KH_DRIVEWAY_WS_X1
KH_DRIVEWAY_WS_X2 = KH_X2 + KH_DRIVEWAY_CURB_WALK_W
KH_DRIVEWAY_RD_X1 = KH_DRIVEWAY_WS_X2
CHARLES_PLT_BR_X = KH_DRIVEWAY_RD_X1 + KH_DRIVEWAY_HW // 2
KH_DRIVEWAY_RD_X2 = KH_DRIVEWAY_RD_X1 + 2 * KH_DRIVEWAY_HW
KH_DRIVEWAY_ES_X1 = KH_DRIVEWAY_RD_X2
KH_DRIVEWAY_ES_X2 = KH_DRIVEWAY_RD_X2 + KH_DRIVEWAY_CURB_WALK_W
KH_DRIVEWAY_JCX_E = KH_DRIVEWAY_ES_X2
KH_CX = (KH_X1 + KH_X2) // 2
KH_EAST_ROOM_CX = (KH_ENT_X2 + KH_X2) // 2
KH_Y1, KH_Y2 = -1888, -256
KH_BIY1 = KH_Y1 + KH_WALL
KH_BIY2 = KH_Y2 - KH_WALL
KH_DRIVEWAY_Y1 = KH_Y1
KH_DRIVEWAY_Y2 = KH_Y2
KH_DRIVEWAY_EXT_Y1 = KH_DRIVEWAY_Y2
...
KH_DRIVEWAY_EXT_Y2 = ENNIS_Y - ENNIS_HW - CHARLES_WALK_W
KH_DRIVEWAY_JCY = ENNIS_Y - ENNIS_HW
...
KH_SHAFT_X1, KH_SHAFT_X2 = KH_ENT_X2 + 16, KH_ENT_X2 + 16 + 128
KH_SHAFT_Y1, KH_SHAFT_Y2 = KH_BIY2 - 128, KH_BIY2
KH_STAIRS_Y2 = KH_SHAFT_Y2
