...
def _build_ennis_entrance_features():
    ...
    def _build_short_wall_section():
        ...
        def _build_short_wall_gate_layout(add_panel, add_connector, add_arch_post):
            ...
            for i in range(sw_panel_count):
                panel_center_x = (
                    sw_run_x1
                    + i * (sw_panel_outer_w + ENNIS_PANEL_GAP)
                    + sw_panel_outer_w // 2
                )
        ...
        _build_gate_run(
            ...
            build_layout=_build_short_wall_gate_layout,
        )
    ...
    def _build_main_gate_section():
        ...
        gate_fence_x1 = (
            ennis_wall_x1 + ENNIS_WALL_T // 2 - 1 - ENNIS_GATE_FENCE_WEST_SHIFT
        )
        ...
        connector_wall_x2 = (
            ennis_wall_x1 + ENNIS_WALL_T // 2 - 1 + ENNIS_GATE_FENCE_BAR_T
        )
        ...
        def _build_main_gate_layout(add_panel, add_connector, add_arch_post):
        ...
        _build_gate_run(
            ...
            build_layout=_build_main_gate_layout,
        )

    def _build_corner_wall_pillar():
    ...
    def _build_cement_wall():
        ...
        cement_wall_pillar_height = (
            cement_wall_height + ENNIS_CEMENT_WALL_PILLAR_EXTRA_H
        )
        brushes.append(
            box(
        ...
        def _build_wall_pillar(pillar_x, with_lamp):
            ...
            if with_lamp:
                ...
                cement_wall_flame_z = (
                    lamppost_base_z + ENNIS_CEMENT_WALL_LAMP_POST_H + 20
                )
                entities.extend(
                    torch_flame(pillar_x, pillar_center_y, cement_wall_flame_z)
                )
                brushes.append(
                    box(
                        pillar_x - 4,
    ...
    _build_entrance_pillars()
    _build_short_wall_section()
    _build_main_gate_section()
    _build_corner_wall_pillar()
    east_gate_brushes = _build_east_gate()
    _build_cement_wall()
