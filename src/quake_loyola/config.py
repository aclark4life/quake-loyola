...
DEFAULTS: dict[str, bool] = {
    ...
    "ENTITIES_ENABLED_TELEPORTS": True,
    "ENTITIES_ENABLED_DM_SPAWNS": True,
    "ENTITIES_ENABLED_WEAPONS": True,
    "ENTITIES_ENABLED_AMMO": True,
    "ENTITIES_ENABLED_HEALTH": True,
    "ENTITIES_ENABLED_MONSTERS": True,
    "ENTITIES_ENABLED_VEGETATION": True,
    "ENTITIES_ENABLED_PLATFORM": True,
    "ENTITIES_ENABLED_EXIT": True,
